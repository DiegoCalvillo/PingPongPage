...
@section('content_español')
<section id="contact">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading">Contáctanos</h2>
                <h3 class="section-subheading text-muted">Llena los siguientes recuadros.</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            {!!Form::email('email',null,['placeholder' => 'Correo Electrónico *', 'class' => 'form-control', 'required'])!!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            {!!Form::textarea('mensaje',null,['placeholder' => 'Escribe un mensaje *', 'class' => 'form-control', 'required'])!!}
                    ...
                    <div class="col-lg-12 text-center">
                        <div id="success"></div>
                        {!!Form::submit('Enviar Mensaje', array('class' => 'btn btn-xl'))!!}
                        {!!Form::close()!!}
